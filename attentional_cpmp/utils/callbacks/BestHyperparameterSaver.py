...
class BestHyperparameterSaver(Callback):
    ...
    def __get_hyp(self, dict_copy_hyp):
        ...
        new_dictionary['heads'] = dict_copy_hyp['num_stacks']
        ...
        neurons_feed = [dict_copy_hyp[f'list_neuron_feed_{i}'] for i in range(new_dictionary['num_neurons_layers_feed'])]
        neurons_hide = [dict_copy_hyp[f'list_neuron_hide_{i}'] for i in range(new_dictionary['num_neurons_layers_hide'])]
